...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 6, 5) == 1     # Test for positive numbers
...
def test_division():
    ...
    assert simple_calculator("divide", -2, 4) == -0.5   # Test for negative and positive + result as float

...
def test_addition():
    ...
    assert simple_calculator("add", 1, -1) == 0         # Test for negative and positive number
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 0, 10) == -10  # Test for negative numbers
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 0, 0) == 0     # Test for multiplication by zero
...
def test_division():
    ...
    assert simple_calculator("divide", 5, -2) == -2.5     # Test for division resulting in float and negative with positive
